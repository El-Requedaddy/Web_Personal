...
import type { uiStrings as esStrings } from './translations/es';
...
/**
 * Translation key — all valid keys from the default (es) dictionary.
 * Using `keyof typeof esStrings` ensures type safety: any key used in `t()`
